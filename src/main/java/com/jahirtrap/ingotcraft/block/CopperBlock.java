...
public class CopperBlock extends IngotcraftModElements.ModElement {
    @ObjectHolder("ingotcraft:copper_block")
    public static final Block block = null;

    public CopperBlock(IngotcraftModElements instance) {
        super(instance, 23);
    }
