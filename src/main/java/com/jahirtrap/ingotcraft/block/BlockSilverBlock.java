...
public class BlockSilverBlock extends ElementsIngotCraft.ModElement {
    @GameRegistry.ObjectHolder("ingotcraft:silver_block")
    public static final Block block = null;

    public BlockSilverBlock(ElementsIngotCraft instance) {
        super(instance, 25);
    }
    ...
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
                new ModelResourceLocation("ingotcraft:silver_block", "inventory"));
    }
