...
public class BronzeBlock extends IngotcraftModElements.ModElement {
    @ObjectHolder("ingotcraft:bronze_block")
    public static final Block block = null;

    public BronzeBlock(IngotcraftModElements instance) {
        super(instance, 11);
    }
