...
public class BlockBronzeBlock extends ElementsIngotCraft.ModElement {
    @GameRegistry.ObjectHolder("ingotcraft:bronze_block")
    public static final Block block = null;

    public BlockBronzeBlock(ElementsIngotCraft instance) {
        super(instance, 11);
    }
    ...
    public void registerModels(ModelRegistryEvent event) {
        ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
                new ModelResourceLocation("ingotcraft:bronze_block", "inventory"));
    }
