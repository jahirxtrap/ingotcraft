...
public class ItemGoldenHammer extends ElementsIngotCraft.ModElement {
    ...
    public ItemGoldenHammer(ElementsIngotCraft instance) {
        super(instance, 34);
    }

    @Override
    public void initElements() {
        elements.items.add(() -> new ItemPickaxe(EnumHelper.addToolMaterial("GOLDEN_HAMMER", 1, 160, 13f, 6f, 22)) {
            {
                this.attackSpeed = -3f;
            }
        ...
        }.setUnlocalizedName("golden_hammer").setRegistryName("golden_hammer").setCreativeTab(TabIngotCraft.tab));
    }
