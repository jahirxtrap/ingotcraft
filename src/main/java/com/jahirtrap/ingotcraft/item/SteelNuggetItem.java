...
public class SteelNuggetItem extends IngotcraftModElements.ModElement {
    @ObjectHolder("ingotcraft:steel_nugget")
    public static final Item block = null;

    public SteelNuggetItem(IngotcraftModElements instance) {
        super(instance, 3);
    }
