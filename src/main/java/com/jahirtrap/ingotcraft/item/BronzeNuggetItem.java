...
public class BronzeNuggetItem extends IngotcraftModElements.ModElement {
    @ObjectHolder("ingotcraft:bronze_nugget")
    public static final Item block = null;

    public BronzeNuggetItem(IngotcraftModElements instance) {
        super(instance, 12);
    }
