...
public class CopperIngotItem extends IngotcraftModElements.ModElement {
    @ObjectHolder("ingotcraft:copper_ingot")
    public static final Item block = null;

    public CopperIngotItem(IngotcraftModElements instance) {
        super(instance, 19);
    }
