...
public class SilverNuggetItem extends IngotcraftModElements.ModElement {
    @ObjectHolder("ingotcraft:silver_nugget")
    public static final Item block = null;

    public SilverNuggetItem(IngotcraftModElements instance) {
        super(instance, 29);
    }
