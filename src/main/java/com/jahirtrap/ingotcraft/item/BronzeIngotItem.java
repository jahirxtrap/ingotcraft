...
public class BronzeIngotItem extends IngotcraftModElements.ModElement {
    @ObjectHolder("ingotcraft:bronze_ingot")
    public static final Item block = null;

    public BronzeIngotItem(IngotcraftModElements instance) {
        super(instance, 10);
    }
