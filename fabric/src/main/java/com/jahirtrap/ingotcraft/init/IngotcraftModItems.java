...
public class IngotcraftModItems {
    ...
    public static final Item STEEL_HELMET = RegistryObject("steel_helmet", new BaseArmorItem(IngotcraftMaterials.STEEL, Type.HELMET, new Item.Properties()));
    public static final Item STEEL_CHESTPLATE = RegistryObject("steel_chestplate", new BaseArmorItem(IngotcraftMaterials.STEEL, Type.CHESTPLATE, new Item.Properties()));
    public static final Item STEEL_LEGGINGS = RegistryObject("steel_leggings", new BaseArmorItem(IngotcraftMaterials.STEEL, Type.LEGGINGS, new Item.Properties()));
    public static final Item STEEL_BOOTS = RegistryObject("steel_boots", new BaseArmorItem(IngotcraftMaterials.STEEL, Type.BOOTS, new Item.Properties()));
    public static final Item BRONZE_HELMET = RegistryObject("bronze_helmet", new BaseArmorItem(IngotcraftMaterials.BRONZE, Type.HELMET, new Item.Properties()));
    public static final Item BRONZE_CHESTPLATE = RegistryObject("bronze_chestplate", new BaseArmorItem(IngotcraftMaterials.BRONZE, Type.CHESTPLATE, new Item.Properties()));
    public static final Item BRONZE_LEGGINGS = RegistryObject("bronze_leggings", new BaseArmorItem(IngotcraftMaterials.BRONZE, Type.LEGGINGS, new Item.Properties()));
    public static final Item BRONZE_BOOTS = RegistryObject("bronze_boots", new BaseArmorItem(IngotcraftMaterials.BRONZE, Type.BOOTS, new Item.Properties()));
    public static final Item INVISIBLE_HELMET = RegistryObject("invisible_helmet", new BaseArmorItem(IngotcraftMaterials.INVISIBLE, Type.HELMET, new Item.Properties()));
    public static final Item INVISIBLE_CHESTPLATE = RegistryObject("invisible_chestplate", new BaseArmorItem(IngotcraftMaterials.INVISIBLE, Type.CHESTPLATE, new Item.Properties()));
    public static final Item INVISIBLE_LEGGINGS = RegistryObject("invisible_leggings", new BaseArmorItem(IngotcraftMaterials.INVISIBLE, Type.LEGGINGS, new Item.Properties()));
    public static final Item INVISIBLE_BOOTS = RegistryObject("invisible_boots", new BaseArmorItem(IngotcraftMaterials.INVISIBLE, Type.BOOTS, new Item.Properties()));
    public static final Item REINFORCED_INVISIBLE_HELMET = RegistryObject("reinforced_invisible_helmet", new BaseArmorItem(IngotcraftMaterials.REINFORCED_INVISIBLE, Type.HELMET, new Item.Properties().rarity(Rarity.RARE)));
    public static final Item REINFORCED_INVISIBLE_CHESTPLATE = RegistryObject("reinforced_invisible_chestplate", new BaseArmorItem(IngotcraftMaterials.REINFORCED_INVISIBLE, Type.CHESTPLATE, new Item.Properties().rarity(Rarity.RARE)));
    public static final Item REINFORCED_INVISIBLE_LEGGINGS = RegistryObject("reinforced_invisible_leggings", new BaseArmorItem(IngotcraftMaterials.REINFORCED_INVISIBLE, Type.LEGGINGS, new Item.Properties().rarity(Rarity.RARE)));
    public static final Item REINFORCED_INVISIBLE_BOOTS = RegistryObject("reinforced_invisible_boots", new BaseArmorItem(IngotcraftMaterials.REINFORCED_INVISIBLE, Type.BOOTS, new Item.Properties().rarity(Rarity.RARE)));
