...
public class IngotcraftModBlocks {
    ...
    public static final Block STEEL_BLOCK = RegistryObject("steel_block", new BaseBlock(Material.METAL, SoundType.METAL));
    public static final Block BRONZE_BLOCK = RegistryObject("bronze_block", new BaseBlock(Material.METAL, SoundType.METAL));
    public static final Block LEAD_BLOCK = RegistryObject("lead_block", new BaseBlock(Material.METAL, SoundType.COPPER));
    public static final Block SILVER_BLOCK = RegistryObject("silver_block", new BaseBlock(Material.METAL, SoundType.METAL));
    public static final Block TIN_BLOCK = RegistryObject("tin_block", new BaseBlock(Material.METAL, SoundType.METAL));
