...
public class ModMaterials {
    public interface Armor {
        ArmorMaterial STEEL = new ArmorMaterial(25, createMap(new int[]{2, 5, 6, 2, 5}),
                9, SoundEvents.ARMOR_EQUIP_IRON, 1f, 0f, ModTags.Items.STEEL_INGOTS, createAsset("steel"));
        ArmorMaterial BRONZE = new ArmorMaterial(15, createMap(new int[]{2, 5, 6, 2, 5}),
                16, SoundEvents.ARMOR_EQUIP_GOLD, 0f, 0f, ModTags.Items.BRONZE_INGOTS, createAsset("bronze"));
