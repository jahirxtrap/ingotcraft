...
public enum IngotcraftMaterials implements ArmorMaterial {
    STEEL("ingotcraft_steel", 25, createMap(new int[]{2, 5, 6, 2}),
            9, SoundEvents.ARMOR_EQUIP_IRON, 1f, 0f, () -> Ingredient.of(IngotcraftModItems.STEEL_INGOT)),
    BRONZE("ingotcraft_bronze", 15, createMap(new int[]{2, 5, 6, 2}),
            16, SoundEvents.ARMOR_EQUIP_GOLD, 0f, 0f, () -> Ingredient.of(IngotcraftModItems.BRONZE_INGOT)),
    INVISIBLE("ingotcraft_invisible", 15, createMap(new int[]{2, 5, 6, 2}),
            9, SoundEvents.ARMOR_EQUIP_GENERIC, 0f, 0f, () -> Ingredient.of(Blocks.GLASS)),
    REINFORCED_INVISIBLE("ingotcraft_invisible", 30, createMap(new int[]{3, 6, 8, 3}),
    ...
    IngotcraftMaterials(String name, int durabilityMultiplier, EnumMap<EquipmentSlot, Integer> defense, int enchantmentValue, SoundEvent sound, float toughness, float knockbackResistance, Supplier<Ingredient> ingredient) {
        this.name = name;
