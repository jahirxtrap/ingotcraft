...
public class ModContent {
    ...
    public static final Item STEEL_INGOT = registerItem("steel_ingot", Item::new, new Item.Properties().trimMaterial(trimKey("steel")));
    public static final Item BRONZE_INGOT = registerItem("bronze_ingot", Item::new, new Item.Properties().trimMaterial(trimKey("bronze")));
    public static final Item LEAD_INGOT = registerItem("lead_ingot", Item::new, new Item.Properties().trimMaterial(trimKey("lead")));
    public static final Item SILVER_INGOT = registerItem("silver_ingot", Item::new, new Item.Properties().trimMaterial(trimKey("silver")));
    public static final Item TIN_INGOT = registerItem("tin_ingot", Item::new, new Item.Properties().trimMaterial(trimKey("tin")));
    ...
    public static final Item COPPER_PICK_HAMMER = registerItem("copper_pick_hammer", (p) -> new BasePickHammerItem(ModMaterials.Tool.COPPER_PICK_HAMMER, p), new Item.Properties());
