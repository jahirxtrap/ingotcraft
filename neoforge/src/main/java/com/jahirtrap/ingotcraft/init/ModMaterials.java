...
public class ModMaterials {
    public interface Armor {
        ArmorMaterial STEEL = new ArmorMaterial(25, createMap(new int[]{2, 5, 6, 2, 5}),
                9, SoundEvents.ARMOR_EQUIP_IRON, 1f, 0f, ItemTags.REPAIRS_IRON_ARMOR, ResourceLocation.fromNamespaceAndPath(MODID, "steel"));
        ArmorMaterial BRONZE = new ArmorMaterial(15, createMap(new int[]{2, 5, 6, 2, 5}),
                16, SoundEvents.ARMOR_EQUIP_GOLD, 0f, 0f, ItemTags.REPAIRS_GOLD_ARMOR, ResourceLocation.fromNamespaceAndPath(MODID, "bronze"));
    ...
    public interface Tool {
        ...
        ToolMaterial ENDERITE_PICK_HAMMER = new ToolMaterial(BlockTags.INCORRECT_FOR_NETHERITE_TOOL, 4096, 16f, 5f, 17, ItemTags.NETHERITE_TOOL_MATERIALS);
