...
public class IngotcraftModItems {
    ...
    public static final DeferredItem<Item> STEEL_HELMET = REGISTRY.register("steel_helmet", () -> new BaseArmorItem(IngotcraftMaterials.STEEL, Type.HELMET, new Item.Properties()));
    public static final DeferredItem<Item> STEEL_CHESTPLATE = REGISTRY.register("steel_chestplate", () -> new BaseArmorItem(IngotcraftMaterials.STEEL, Type.CHESTPLATE, new Item.Properties()));
    public static final DeferredItem<Item> STEEL_LEGGINGS = REGISTRY.register("steel_leggings", () -> new BaseArmorItem(IngotcraftMaterials.STEEL, Type.LEGGINGS, new Item.Properties()));
    public static final DeferredItem<Item> STEEL_BOOTS = REGISTRY.register("steel_boots", () -> new BaseArmorItem(IngotcraftMaterials.STEEL, Type.BOOTS, new Item.Properties()));
    public static final DeferredItem<Item> BRONZE_HELMET = REGISTRY.register("bronze_helmet", () -> new BaseArmorItem(IngotcraftMaterials.BRONZE, Type.HELMET, new Item.Properties()));
    public static final DeferredItem<Item> BRONZE_CHESTPLATE = REGISTRY.register("bronze_chestplate", () -> new BaseArmorItem(IngotcraftMaterials.BRONZE, Type.CHESTPLATE, new Item.Properties()));
    public static final DeferredItem<Item> BRONZE_LEGGINGS = REGISTRY.register("bronze_leggings", () -> new BaseArmorItem(IngotcraftMaterials.BRONZE, Type.LEGGINGS, new Item.Properties()));
    public static final DeferredItem<Item> BRONZE_BOOTS = REGISTRY.register("bronze_boots", () -> new BaseArmorItem(IngotcraftMaterials.BRONZE, Type.BOOTS, new Item.Properties()));
    public static final DeferredItem<Item> INVISIBLE_HELMET = REGISTRY.register("invisible_helmet", () -> new BaseArmorItem(IngotcraftMaterials.INVISIBLE, Type.HELMET, new Item.Properties()));
    public static final DeferredItem<Item> INVISIBLE_CHESTPLATE = REGISTRY.register("invisible_chestplate", () -> new BaseArmorItem(IngotcraftMaterials.INVISIBLE, Type.CHESTPLATE, new Item.Properties()));
    public static final DeferredItem<Item> INVISIBLE_LEGGINGS = REGISTRY.register("invisible_leggings", () -> new BaseArmorItem(IngotcraftMaterials.INVISIBLE, Type.LEGGINGS, new Item.Properties()));
    public static final DeferredItem<Item> INVISIBLE_BOOTS = REGISTRY.register("invisible_boots", () -> new BaseArmorItem(IngotcraftMaterials.INVISIBLE, Type.BOOTS, new Item.Properties()));
    public static final DeferredItem<Item> REINFORCED_INVISIBLE_HELMET = REGISTRY.register("reinforced_invisible_helmet", () -> new BaseArmorItem(IngotcraftMaterials.REINFORCED_INVISIBLE, Type.HELMET, new Item.Properties().rarity(Rarity.RARE)));
    public static final DeferredItem<Item> REINFORCED_INVISIBLE_CHESTPLATE = REGISTRY.register("reinforced_invisible_chestplate", () -> new BaseArmorItem(IngotcraftMaterials.REINFORCED_INVISIBLE, Type.CHESTPLATE, new Item.Properties().rarity(Rarity.RARE)));
    public static final DeferredItem<Item> REINFORCED_INVISIBLE_LEGGINGS = REGISTRY.register("reinforced_invisible_leggings", () -> new BaseArmorItem(IngotcraftMaterials.REINFORCED_INVISIBLE, Type.LEGGINGS, new Item.Properties().rarity(Rarity.RARE)));
    public static final DeferredItem<Item> REINFORCED_INVISIBLE_BOOTS = REGISTRY.register("reinforced_invisible_boots", () -> new BaseArmorItem(IngotcraftMaterials.REINFORCED_INVISIBLE, Type.BOOTS, new Item.Properties().rarity(Rarity.RARE)));
