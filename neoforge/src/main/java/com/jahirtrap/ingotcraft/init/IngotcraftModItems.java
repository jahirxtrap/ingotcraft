...
public class IngotcraftModItems {
    ...
    public static final DeferredItem<Item> RAW_BRONZE = REGISTRY.register("raw_bronze", RawBronzeItem::new);
    ...
    public static final DeferredItem<Item> BRONZE_HELMET = REGISTRY.register("bronze_helmet", BronzeItem.Helmet::new);
    public static final DeferredItem<Item> BRONZE_CHESTPLATE = REGISTRY.register("bronze_chestplate", BronzeItem.Chestplate::new);
    public static final DeferredItem<Item> BRONZE_LEGGINGS = REGISTRY.register("bronze_leggings", BronzeItem.Leggings::new);
    public static final DeferredItem<Item> BRONZE_BOOTS = REGISTRY.register("bronze_boots", BronzeItem.Boots::new);
    ...
    public static final DeferredItem<Item> REINFORCED_INVISIBLE_HELMET = REGISTRY.register("reinforced_invisible_helmet", ReinforcedInvisibleItem.Helmet::new);
    public static final DeferredItem<Item> REINFORCED_INVISIBLE_CHESTPLATE = REGISTRY.register("reinforced_invisible_chestplate", ReinforcedInvisibleItem.Chestplate::new);
    public static final DeferredItem<Item> REINFORCED_INVISIBLE_LEGGINGS = REGISTRY.register("reinforced_invisible_leggings", ReinforcedInvisibleItem.Leggings::new);
    public static final DeferredItem<Item> REINFORCED_INVISIBLE_BOOTS = REGISTRY.register("reinforced_invisible_boots", ReinforcedInvisibleItem.Boots::new);
