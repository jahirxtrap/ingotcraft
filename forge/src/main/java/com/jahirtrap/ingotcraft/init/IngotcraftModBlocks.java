...
public class IngotcraftModBlocks {
    ...
    public static final RegistryObject<Block> STEEL_BLOCK = REGISTRY.register("steel_block", () -> new BaseBlock(MapColor.METAL, SoundType.METAL));
    public static final RegistryObject<Block> BRONZE_BLOCK = REGISTRY.register("bronze_block", () -> new BaseBlock(MapColor.METAL, SoundType.METAL));
    public static final RegistryObject<Block> LEAD_BLOCK = REGISTRY.register("lead_block", () -> new BaseBlock(MapColor.METAL, SoundType.COPPER));
    public static final RegistryObject<Block> SILVER_BLOCK = REGISTRY.register("silver_block", () -> new BaseBlock(MapColor.METAL, SoundType.METAL));
    public static final RegistryObject<Block> TIN_BLOCK = REGISTRY.register("tin_block", () -> new BaseBlock(MapColor.METAL, SoundType.METAL));
}
