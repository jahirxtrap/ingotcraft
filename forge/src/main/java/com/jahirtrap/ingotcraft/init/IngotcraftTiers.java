...
public enum IngotcraftTiers implements Tier {
    STEEL(BlockTags.INCORRECT_FOR_IRON_TOOL, 501, 6.5f, 2f, 14, () -> Ingredient.of(IngotcraftModItems.STEEL_INGOT.get())),
    BRONZE(BlockTags.INCORRECT_FOR_IRON_TOOL, 350, 7f, 2f, 16, () -> Ingredient.of(IngotcraftModItems.BRONZE_INGOT.get())),
    ...
    STEEL_HAMMER(BlockTags.INCORRECT_FOR_IRON_TOOL, 501, 7.5f, 2f, 14, () -> Ingredient.of(IngotcraftModItems.STEEL_INGOT.get())),
    BRONZE_HAMMER(BlockTags.INCORRECT_FOR_IRON_TOOL, 350, 8f, 2f, 16, () -> Ingredient.of(IngotcraftModItems.BRONZE_INGOT.get())),
