...
public class IngotcraftModItems {
    ...
    public static final RegistryObject<Item> REINFORCED_INVISIBLE_HELMET = REGISTRY.register("reinforced_invisible_helmet", ReinforcedInvisibleItem.Helmet::new);
    public static final RegistryObject<Item> REINFORCED_INVISIBLE_CHESTPLATE = REGISTRY.register("reinforced_invisible_chestplate", ReinforcedInvisibleItem.Chestplate::new);
    public static final RegistryObject<Item> REINFORCED_INVISIBLE_LEGGINGS = REGISTRY.register("reinforced_invisible_leggings", ReinforcedInvisibleItem.Leggings::new);
    public static final RegistryObject<Item> REINFORCED_INVISIBLE_BOOTS = REGISTRY.register("reinforced_invisible_boots", ReinforcedInvisibleItem.Boots::new);
