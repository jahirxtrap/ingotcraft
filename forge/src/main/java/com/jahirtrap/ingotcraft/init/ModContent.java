...
public class ModContent {
    ...
    public static final RegistryObject<Item> STEEL_HELMET = registerItem("steel_helmet", () -> new BaseArmorItem(ModMaterials.STEEL, Type.HELMET, 25, new Item.Properties()));
    public static final RegistryObject<Item> STEEL_CHESTPLATE = registerItem("steel_chestplate", () -> new BaseArmorItem(ModMaterials.STEEL, Type.CHESTPLATE, 25, new Item.Properties()));
    public static final RegistryObject<Item> STEEL_LEGGINGS = registerItem("steel_leggings", () -> new BaseArmorItem(ModMaterials.STEEL, Type.LEGGINGS, 25, new Item.Properties()));
    public static final RegistryObject<Item> STEEL_BOOTS = registerItem("steel_boots", () -> new BaseArmorItem(ModMaterials.STEEL, Type.BOOTS, 25, new Item.Properties()));
    public static final RegistryObject<Item> BRONZE_HELMET = registerItem("bronze_helmet", () -> new BaseArmorItem(ModMaterials.BRONZE, Type.HELMET, 15, new Item.Properties()));
    public static final RegistryObject<Item> BRONZE_CHESTPLATE = registerItem("bronze_chestplate", () -> new BaseArmorItem(ModMaterials.BRONZE, Type.CHESTPLATE, 15, new Item.Properties()));
    public static final RegistryObject<Item> BRONZE_LEGGINGS = registerItem("bronze_leggings", () -> new BaseArmorItem(ModMaterials.BRONZE, Type.LEGGINGS, 15, new Item.Properties()));
    public static final RegistryObject<Item> BRONZE_BOOTS = registerItem("bronze_boots", () -> new BaseArmorItem(ModMaterials.BRONZE, Type.BOOTS, 15, new Item.Properties()));
