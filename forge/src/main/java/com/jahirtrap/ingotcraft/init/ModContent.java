...
public class ModContent {
    ...
    public static final RegistryObject<Item> STEEL_INGOT = registerItem("steel_ingot", Item::new, new Item.Properties().trimMaterial(trimKey("steel")));
    public static final RegistryObject<Item> BRONZE_INGOT = registerItem("bronze_ingot", Item::new, new Item.Properties().trimMaterial(trimKey("bronze")));
    public static final RegistryObject<Item> LEAD_INGOT = registerItem("lead_ingot", Item::new, new Item.Properties().trimMaterial(trimKey("lead")));
    public static final RegistryObject<Item> SILVER_INGOT = registerItem("silver_ingot", Item::new, new Item.Properties().trimMaterial(trimKey("silver")));
    public static final RegistryObject<Item> TIN_INGOT = registerItem("tin_ingot", Item::new, new Item.Properties().trimMaterial(trimKey("tin")));
    ...
    public static final RegistryObject<Item> COPPER_PICK_HAMMER = registerItem("copper_pick_hammer", (p) -> new BasePickHammerItem(ModMaterials.Tool.COPPER_PICK_HAMMER, p), new Item.Properties());
