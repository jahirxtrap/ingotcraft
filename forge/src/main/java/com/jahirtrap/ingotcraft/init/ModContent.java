...
public class ModContent {
    ...
    public static final RegistryObject<Item> ZURITE_PICK_HAMMER = registerItem("zurite_pick_hammer", () -> new BasePickHammerItem(ModTiers.ZURITE_PICK_HAMMER, new Item.Properties().fireResistant()));
